...
else{ throw new Error('Contrato não mutável'); }
}

/**
 * Mudar nome do contratado
 * @param {org.teste2.virtue.mudarContratado} tradeContratado 
 * @transaction
 */

async function mudarContratado(tradeContratado){
...
/**
 * Mudar nome do agente de reflorestamento
